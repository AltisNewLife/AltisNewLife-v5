 ...
 *
 * [5,[[false,"Test",false,5]], {[(_this select 0),(_this select 1),(_this select 2),(_this select 3)] call life_fnc_hint},{hint "Abbgebrochen"},"Repariere"] spawn rl_fnc_progressBar
 */
private["_progress","_startTime","_sleepTime","_display","_label","_progressBarBackground","_progressBarMaxSize","_progressBar","_totalTime","_onFinish", "_onFail","_localizedTitle","_return"];
